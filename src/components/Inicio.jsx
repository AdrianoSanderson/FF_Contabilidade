        ...
        <section className='bg-teal-700  flex justify-center'>
            <div className='flex flex-col justify-items-center items-center  md:flex-row md:w-4/5 md:mb-10'>
                <div className='m-5 md:w-1/2'>
                    <h1 className='text-slate-50 text-3xl font-semibold mb-4 mt-12 md:mt-28 lg:text-5xl
                '>Soluções contábeis para simplificar a gestão do seu negócio</h1>
                    <h2 className='text-slate-50 text-2xl text-justify mb-4 lg:text-2xl'>Com ampla experiência em departamento pessoal e fiscal, ofereço soluções práticas e eficientes para atender às necessidades contábeis do seu negócio.</h2>
